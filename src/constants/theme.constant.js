...
export const LOGO_ESCUDO = 'escudo.png'
export const LOGO_APP = 'logo.png'

export const THEME_COLOR            = 'buke'
export const THEME_COLOR_SUCCESS    = 'emerald'
export const THEME_COLOR_DANGER     = 'red'
export const THEME_COLOR_WARNING    = 'yellow'
export const THEME_COLOR_INFO       = 'blue'
export const THEME_COLOR_PRIMARY    = 'buke'
export const THEME_COLOR_SECONDARY  = 'slate'

export const PRIMARY_COLOR_LEVEL    = 600
export const SECONDARY_COLOR_LEVEL  = 500
export const THIRD_COLOR_LEVEL      = 400
...
export const THEME_ENUM = {
    ...
    PRIMARY_COLOR_LEVEL:                PRIMARY_COLOR_LEVEL,

    THEME_COLOR_PRIMARY:                THEME_COLOR_PRIMARY,
    THEME_COLOR_SECONDARY:              THEME_COLOR_SECONDARY,
    SECONDARY_COLOR_LEVEL:              SECONDARY_COLOR_LEVEL,
    THIRD_COLOR_LEVEL:                  THIRD_COLOR_LEVEL,
}
