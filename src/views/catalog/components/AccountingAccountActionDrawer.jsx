...
import AccountingAccountForm from './AccountingAccountForm';

const AccountingAccountActionDrawer = ({
    isOpen,
    onClose,
    onSubmit,
    initialValues,
    ...
    const title = isEdit ? 'Editar Cuenta Contable' : 'Nueva Cuenta Contable';
...
export default AccountingAccountActionDrawer;
