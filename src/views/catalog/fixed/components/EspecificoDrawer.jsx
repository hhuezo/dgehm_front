...
import EspecificoForm from './EspecificoForm'

const EspecificoDrawer = ({ isOpen, onClose, onSubmit, initialValues, isEdit }) => {
    const title = isEdit ? 'Editar específico' : 'Nuevo específico'
...
export default EspecificoDrawer
