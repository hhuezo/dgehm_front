...
const FixedAssetTable = ({
    ...
    const ActionColumn = ({ row }) => (
        <div className="flex justify-end items-center gap-1">
            <AuthorityCheck userPermissions={userPermissions} permissions={['fixed_assets update']}>
                <button
                    title="Editar"
            ...
            <AuthorityCheck userPermissions={userPermissions} permissions={['fixed_assets delete']}>
                <button
                    title="Eliminar"
    ...
    return (
        <>
            <div className="flex justify-between items-center border-b px-4 py-3">
                ...
                <AuthorityCheck userPermissions={userPermissions} permissions={['fixed_assets create']}>
                    <button
